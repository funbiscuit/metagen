...
add_library({APP_META_LIB_NAME} STATIC ${{CMAKE_CURRENT_SOURCE_DIR}}/src/meta.c)
target_include_directories({APP_META_LIB_NAME} PUBLIC ${{CMAKE_CURRENT_SOURCE_DIR}}/include)
{sources}
"""
...
def process_config():
    ...
    with open(output + "/CMakeLists.txt", "w") as cmakeLists:
        ...
        cmakeLists.write(CMAKE_TEMPLATE.format(APP_META_LIB_NAME=project_name, sources=sources))
        cmakeLists.close()
